					...
					<div class="row">
						<div class="col-lg-8 col-md-6">
							<div class="row">
								...
								<!-- 회원가입 시 토탈 값(0) DB에 저장. 회원 정보 페이지 들어오면 값 불러오기 -->
								...
								<div class="col-lg-6">
									<div class="checkout__input">
										...
										<div class="container">
											...
											<div class="row">
											<a href="/member/temperature">
												<button
													class="btn btn-lg bg-warning d-flex flex-row justify-content-center"
													onclick="${ total + 1 }">나빠요</button>
											</a>
												&nbsp;
											<a href="/member/temperature">
												<button
													class="btn btn-lg bg-warning d-flex flex-row justify-content-center"
													onclick="${ total - 1 }" >좋아요</button>
											</a>
											</div>
										</div>
									</div>
									...
									<div class="checkout__input">
										...
										<p>
											<input id="member_post" type="text" readonly="readonly"
												value="${ sessionScope.address1 }" name="address1">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="checkout__input">
