          ...
          <div class="border border-info p-4 rounded">
            ...
            <form action="/products/write" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="seller_id" aria-describedby="idHelp" name="seller_id" value="${ sessionScope.id }" readonly>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="sell_price" name="sell_price" autofocus>
              </div>
