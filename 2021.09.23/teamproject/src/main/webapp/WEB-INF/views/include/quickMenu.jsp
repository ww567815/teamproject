	...
	<div class="header__banner-right">
		<div class="floar_sidebar">
			...
			<a href="javascript:history.back();">
				<button class="btn btn-lg bg-light">◀</button>
			</a> <a href="javascript:history.forword();">
				<button class="btn btn-lg bg-light">▶</button>
			</a>
			<button class="btn btn-lg bg-light" onclick="goTop()">▲</button>
			<button class="btn btn-lg bg-light" onclick="goBottom()">▼</button>
		</div>
	</div>
</body>